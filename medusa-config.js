...
// Uncomment this for REDIS instance
const modules = {
  // eventBus: {
  //   resolve: "@medusajs/event-bus-redis",
  //   options: {
  //     redisUrl: REDIS_URL,
  //     family: 0, // Specify the IPv6 family option here
  //   }
  // },
  // cacheService: {
...
const projectConfig = {
  ...
  port: process.env.PORT || 9000,   // ✅ cast to integer
...
module.exports = {
  ...
  migrations: [
    "dist/migrations/*.js", // for production build
